...
ALTER TABLE public.bilhete ADD CONSTRAINT FK_bilhete__passaporte_passageiro FOREIGN KEY (passaporte_passageiro) REFERENCES public.passageiro_trajeto(passaporte_passageiro);
...
ALTER TABLE public.passageiro_trajeto ADD CONSTRAINT FK_passageiro_trajeto__passaporte_passageiro FOREIGN KEY (passaporte_passageiro) REFERENCES public.passageiro(passaporte_passageiro);
ALTER TABLE public.passageiro_trajeto ADD CONSTRAINT FK_passageiro_trajeto__codigo_origem FOREIGN KEY (codigo_origem) REFERENCES public.trajeto(codigo_origem);
ALTER TABLE public.passageiro_trajeto ADD CONSTRAINT FK_passageiro_trajeto__codigo_destino FOREIGN KEY (codigo_destino) REFERENCES public.trajeto(codigo_destino);